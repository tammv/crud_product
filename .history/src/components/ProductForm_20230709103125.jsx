        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            {showAlert && !inputValues.name && (
              <div className="invalid-feedback">Please enter a valid name.(Do not leave it with empty)</div>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {showAlert && (!inputValues.price || isNaN(inputValues.price)) && (
              <div className="invalid-feedback">Please enter a valid price.(Only Number)</div>
            )}
          </div>
